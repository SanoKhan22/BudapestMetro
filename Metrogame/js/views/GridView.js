...
const GridView = (function() {
  ...
  return {
     ...
     */
    renderGrid(stations) {
      // Re-initialize elements to ensure we have the latest DOM reference
      initElements();
      ...
      console.log('Rendering grid with', stations.length, 'stations');
      
      // Create grid structure with SVG overlay
      const gridHTML = `
    ...
    renderSegment(fromId, toId, color, lineName) {
      ...
      // Get the actual station elements to find their centers
